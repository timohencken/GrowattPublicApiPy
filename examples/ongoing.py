...
if __name__ == "__main__":
    ...
    # TODO API v4
    # _v4_details_inv_ = ga.v4.details(device_sn=INVERTER_SN, device_type="inv")
    # _v4_details_sto_ = ga.v4.details(device_sn=INVERTER_SN, device_type="storage")
    # _v4_details_sph_ = ga.v4.details(device_sn=INVERTER_SN, device_type="sph")
    _v4_details_max_ = ga.v4.details(device_sn=INVERTER_SN, device_type="max")
    _v4_details_spa_ = ga.v4.details(device_sn=INVERTER_SN, device_type="spa")
    _v4_details_min_ = ga.v4.details(device_sn=INVERTER_SN, device_type="min")
    _v4_details_wit_ = ga.v4.details(device_sn=INVERTER_SN, device_type="wit")
    _v4_details_sphs_ = ga.v4.details(device_sn=INVERTER_SN, device_type="sph-s")
    _v4_details_noah_ = ga.v4.details(device_sn=INVERTER_SN, device_type="noah")
