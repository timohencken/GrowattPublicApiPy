import datetime
from typing import Union, Any, List, Optional, TypeAlias, Annotated
...
class SphDetailData(ApiModel):
    ...
    bat_temp_upper_limit_c: Union[EmptyStrToNone, float] = (
        None  # Upper limit of battery charging temperature, e.g. 60
    )
    bat_temp_upper_limit_d: Union[EmptyStrToNone, float] = (
        None  # Upper limit of battery discharge temperature, e.g. 70
    )
    ...
    priority_choose: Union[EmptyStrToNone, int] = (
        None  # Energy priority selection, e.g. 0
    )
    ...
    vbat_start_for_charge: Union[EmptyStrToNone, float] = (
        None  # Battery charging upper limit voltage, e.g. 58
    )
    ...
    vbat_warn_clr: Union[EmptyStrToNone, float] = (
        None  # Low battery voltage recovery point, e.g. 5
    )
...
class SphEnergyOverviewData(ApiModel):
    ...
    ac_charge_energy_today: Union[EmptyStrToNone, float] = (
        None  # AC daily charge, e.g. 0
    )
    ac_charge_energy_total: Union[EmptyStrToNone, float] = (
        None  # AC total charge, e.g. 0
    )
    ...
    battery_temperature: Union[EmptyStrToNone, float] = (
        None  # Battery temperature, e.g. 0
    )
    battery_type: Union[EmptyStrToNone, int] = None  # e.g. 0
    bms_battery_curr: Union[EmptyStrToNone, float] = None  # Battery current, e.g. 0
    bms_battery_temp: Union[EmptyStrToNone, float] = (
        None  # Battery temperature, e.g. 28
    )
    bms_battery_volt: Union[EmptyStrToNone, float] = (
        None  # Battery voltage, e.g. 56.7400016784668
    )
    bms_cell1_volt: Union[EmptyStrToNone, float] = (
        None  # Battery cell 1 voltage, e.g. 3.5480000972747803
    )
    bms_cell2_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell 2 voltage, e.g. 3.5480000972747803
    )
    bms_cell3_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.549999952316284
    )
    bms_cell4_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.549999952316284
    )
    bms_cell5_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.549999952316284
    )
    bms_cell6_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.5510001182556152
    )
    bms_cell7_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.549999952316284
    )
    bms_cell8_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.549999952316284
    )
    bms_cell9_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.513000011444092
    )
    bms_cell10_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.549999952316284
    )
    bms_cell11_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.549999952316284
    )
    bms_cell12_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.549999952316284
    )
    bms_cell13_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.5490000247955322
    )
    bms_cell14_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.5490000247955322
    )
    bms_cell15_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.5490000247955322
    )
    bms_cell16_volt: Union[EmptyStrToNone, float] = (
        None  # Battery single cell n voltage, e.g. 3.549999952316284
    )
    bms_constant_volt: Union[EmptyStrToNone, float] = (
        None  # Battery charging constant voltage point, e.g. 56.79999923706055
    )
    bms_cycle_cnt: Union[EmptyStrToNone, int] = (
        None  # Number of battery cycles, e.g. 1331
    )
    bms_delta_volt: Union[EmptyStrToNone, float] = (
        None  # Pressure difference between battery cells, e.g. 38
    )
    ...
    bms_gauge_rm: Union[EmptyStrToNone, float] = (
        None  # System Capacity, e.g. 49.9900016784668
    )
    ...
    bms_max_curr: Union[EmptyStrToNone, float] = (
        None  # Maximum charge and discharge current, e.g. 100
    )
    bms_max_dischg_curr: Union[EmptyStrToNone, float] = (
        None  # Maximum discharge current, e.g. 0
    )
    bms_pack_info: Union[EmptyStrToNone, int] = (
        None  # Battery Pack Information, e.g. 257
    )
    ...
    bms_status_old: Union[EmptyStrToNone, int] = (
        None  # Battery history status, e.g. 361
    )
    bms_using_cap: Union[EmptyStrToNone, int] = (
        None  # Battery pack power type, e.g. 5000
    )
    bms_warn_info: Union[EmptyStrToNone, int] = (
        None  # Battery warning information, e.g. 0
    )
    bms_warn_info_old: Union[EmptyStrToNone, int] = (
        None  # Battery historical warning information, e.g. 0
    )
    ...
    echarge1_today: Union[EmptyStrToNone, float] = (
        None  # Daily battery charge, e.g. 0.2
    )
    echarge1_total: Union[EmptyStrToNone, float] = (
        None  # Total battery charge, e.g. 6113.2
    )
    edischarge1_today: Union[EmptyStrToNone, float] = (
        None  # Daily battery discharge, e.g. 0.4
    )
    edischarge1_total: Union[EmptyStrToNone, float] = (
        None  # Total battery discharge, e.g. 5540.6
    )
    elocal_load_today: Union[EmptyStrToNone, float] = (
        None  # Daily power consumption of local load, e.g. 0
    )
    elocal_load_total: Union[EmptyStrToNone, float] = (
        None  # Total local load power consumption, e.g. 26980.8
    )
    eps_vac2: Union[EmptyStrToNone, float] = (
        None  # S-phase voltage on off-grid side, e.g.  0
    )
    eps_vac3: Union[EmptyStrToNone, float] = (
        None  # T-phase voltage on off-grid side, e.g. 0
    )
    ...
    e_to_user_today: Union[EmptyStrToNone, float] = (
        None  # Grid Sunrise Electricity, e.g. 0
    )
    e_to_user_total: Union[EmptyStrToNone, float] = (
        None  # Total grid electricity output, e.g. 11991.1
    )
    e_to_grid_today: Union[EmptyStrToNone, float] = (
        None  # Daily grid electricity, e.g. 0.3
    )
    ...
    pac_to_grid_r: Union[EmptyStrToNone, float] = (
        None  # Grid reverse current power, e.g. 38.6
    )
    pac_to_grid_total: Union[EmptyStrToNone, float] = (
        None  # Total grid countercurrent power, e.g. 38.6
    )
    pac_to_user_r: Union[EmptyStrToNone, float] = None  # Grid downstream power, e.g. 0
    pac_to_user_total: Union[EmptyStrToNone, float] = (
        None  # Total downstream power of the grid, e.g. 0
    )
    pcharge1: Union[EmptyStrToNone, float] = None  # Battery charging power, e.g. 0
    pdischarge1: Union[EmptyStrToNone, float] = (
        None  # Battery discharge power, e.g. 16.5
    )
    plocal_load_r: Union[EmptyStrToNone, float] = (
        None  # Local load power consumption, e.g. 0
    )
    plocal_load_total: Union[EmptyStrToNone, float] = (
        None  # Total local load power consumption, e.g. 0
    )
    ...
    status: Union[EmptyStrToNone, int] = (
        None  # Mix Status 0 = waiting, 1 = normal, 2 = fault, e.g. 5
    )
    ...
    ups_load_percent: Union[EmptyStrToNone, float] = (
        None  # Emergency output load rate, e.g. 0
    )
    ups_pf: Union[EmptyStrToNone, float] = (
        None  # Emergency output power factor, e.g. 1000
    )
    ups_pac1: Union[EmptyStrToNone, float] = (
        None  # Emergency output apparent power, e.g. 0
    )
    ...
    v_bat_dsp: Union[EmptyStrToNone, float] = (
        None  # Battery voltage collected by DSP, e.g. 0
    )
...
class SphEnergyOverview(ApiResponse):
    ...
    datalogger_sn: Union[EmptyStrToNone, str] = (
        None  # The collector SN of the inverter, e.g. "BQC0733010"
    )
