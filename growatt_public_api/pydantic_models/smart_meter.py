...
class SmartMeterEnergyOverviewData(ApiModel):
    ...
    active_power: Union[EmptyStrToNone, float] = (
        None  # Total active power, e.g. 5589.60009765625
    )
    ...
    active_power_max_need: Union[EmptyStrToNone, float] = (
        None  # Total active power maximum demand, e.g. 0
    )
    active_power_max_need_one: Union[EmptyStrToNone, float] = (
        None  # Maximum total active power demand, e.g. 0
    )
    active_power_need: Union[EmptyStrToNone, float] = (
        None  # Current total active power demand, e.g. 0
    )
    active_power_need_one: Union[EmptyStrToNone, float] = (
        None  # Total active power demand, e.g. 0
    )
    ...
    apparent_energy_max_need: Union[EmptyStrToNone, float] = (
        None  # Current total apparent power maximum demand, e.g. 0
    )
    apparent_energy_need: Union[EmptyStrToNone, float] = (
        None  # Current total apparent power demand, e.g. 0
    )
    apparent_power: Union[EmptyStrToNone, float] = (
        None  # Total apparent power, e.g. 6025.5
    )
    ...
    b_reactive_power: Union[EmptyStrToNone, float] = (
        None  # Phase B reactive power, e.g. 0
    )
    ...
    c_reactive_power: Union[EmptyStrToNone, float] = (
        None  # C-phase reactive power, e.g. 0
    )
    ...
    current_l1_max_need: Union[EmptyStrToNone, float] = (
        None  # L1 current maximum demand, e.g. 0
    )
    current_l1_need: Union[EmptyStrToNone, float] = (
        None  # Current L1 current demand, e.g. 0
    )
    current_l2: Union[EmptyStrToNone, float] = None  # current L2, e.g. 0
    current_l2_max_need: Union[EmptyStrToNone, float] = (
        None  # L2 current maximum demand, e.g. 0
    )
    current_l2_need: Union[EmptyStrToNone, float] = (
        None  # Current L2 current demand, e.g. 0
    )
    current_l3: Union[EmptyStrToNone, float] = None  # current L3, e.g. 0
    current_l3_max_need: Union[EmptyStrToNone, float] = (
        None  # L3 current maximum demand, e.g. 0
    )
    current_l3_need: Union[EmptyStrToNone, float] = (
        None  # Current L3 current demand, e.g. 0
    )
    current_max_need: Union[EmptyStrToNone, float] = (
        None  # Maximum current demand, e.g. 0
    )
    ...
    forward_active_max_need: Union[EmptyStrToNone, float] = (
        None  # Maximum forward active power demand, e.g. 0
    )
    forward_active_need: Union[EmptyStrToNone, float] = (
        None  # forward active power demand, e.g. 0
    )
    ...
    instant_total_apparent_power: Union[EmptyStrToNone, float] = (
        None  # Instantaneous total apparent power, e.g. 0
    )
    instant_total_active_power: Union[EmptyStrToNone, float] = (
        None  # instantly total active power, e.g. 0
    )
    instant_total_reactive_power: Union[EmptyStrToNone, float] = (
        None  # instantly total reactive power, e.g. 0
    )
    l1_current_harmonic: Union[EmptyStrToNone, float] = (
        None  # L1 current total harmonic content, e.g. 0
    )
    l1_voltage2: Union[EmptyStrToNone, float] = None  # L1-2 line voltage, e.g. 0
    l1_voltage_harmonic: Union[EmptyStrToNone, float] = (
        None  # L1 phase voltage total harmonic content, e.g. 0
    )
    l1_voltage_harmonic2: Union[EmptyStrToNone, float] = (
        None  # L1-2 line voltage total harmonic content, e.g. 0
    )
    l2_current_harmonic: Union[EmptyStrToNone, float] = (
        None  # L2 current total harmonic content, e.g. 0
    )
    l2_voltage3: Union[EmptyStrToNone, float] = None  # L2-3 line voltage, e.g. 0
    l2_voltage_harmonic: Union[EmptyStrToNone, float] = (
        None  # L2 phase voltage total harmonic content, e.g. 0
    )
    l2_voltage_harmonic3: Union[EmptyStrToNone, float] = (
        None  # L2-3 line voltage total harmonic content, e.g. 0
    )
    l3_current_harmonic: Union[EmptyStrToNone, float] = (
        None  # L3 current total harmonic content, e.g. 0
    )
    l3_voltage1: Union[EmptyStrToNone, float] = None  # L3-1 line voltage, e.g. 0
    l3_voltage_harmonic: Union[EmptyStrToNone, float] = (
        None  # L3 phase voltage total harmonic content, e.g. 0
    )
    l3_voltage_harmonic1: Union[EmptyStrToNone, float] = (
        None  # L3-1 line voltage total harmonic content, e.g. 0
    )
    ...
    posi_active_power: Union[EmptyStrToNone, float] = (
        None  # Positive active power, e.g. 0
    )
    posi_reactive_net_total_energy: Union[EmptyStrToNone, float] = None  # e.g. 0
    posi_reactive_power: Union[EmptyStrToNone, float] = (
        None  # Positive reactive power, e.g. 0
    )
    positive_active_today_energy: Union[EmptyStrToNone, float] = None  # e.g. 0
    positive_active_total_energy: Union[EmptyStrToNone, float] = (
        None  # positive active total energy, e.g. 0
    )
    ...
    reactive_power: Union[EmptyStrToNone, float] = (
        None  # Total reactive power, e.g. 168.89999389648438
    )
    ...
    reverse_active_power: Union[EmptyStrToNone, float] = (
        None  # reverse active power, e.g. 0
    )
    ...
    reverse_reactive_power: Union[EmptyStrToNone, float] = (
        None  # Reverse reactive power, e.g. 0
    )
    reverse_active_energy: Union[EmptyStrToNone, float] = None  # e.g. 0
    reverse_active_max_need: Union[EmptyStrToNone, float] = (
        None  # Maximum reverse active power demand, e.g. 0
    )
    reverse_active_need: Union[EmptyStrToNone, float] = (
        None  # reverse active power demand, e.g. 0
    )
    reverse_active_today_energy: Union[EmptyStrToNone, float] = (
        None  # Reverse active total energy, e.g. 0
    )
    ...
    total_active_energy_l1: Union[EmptyStrToNone, float] = (
        None  # total active energy L1, e.g. 0
    )
    total_active_energy_l2: Union[EmptyStrToNone, float] = (
        None  # total active energy L2, e.g. 0
    )
    total_active_energy_l3: Union[EmptyStrToNone, float] = (
        None  # total active energy L3, e.g. 0
    )
    total_energy: Union[EmptyStrToNone, float] = (
        None  # Total energy of the meter, e.g. 0
    )
    total_reactive_energy_l1: Union[EmptyStrToNone, float] = (
        None  # total reactive energy L1, e.g. 0
    )
    total_reactive_energy_l2: Union[EmptyStrToNone, float] = (
        None  # total reactive energy L2, e.g. 0
    )
    total_reactive_energy_l3: Union[EmptyStrToNone, float] = (
        None  # total reactive energy L3, e.g. 0
    )
    ...
    voltage_ua: Union[EmptyStrToNone, float] = (
        None  # Three-phase phase voltage Ua, e.g. 0
    )
    voltage_uab: Union[EmptyStrToNone, float] = (
        None  # Three-phase line voltage Uab, e.g. 0
    )
    voltage_ub: Union[EmptyStrToNone, float] = (
        None  # Three-phase phase voltage Ub, e.g. 0
    )
    voltage_ubc: Union[EmptyStrToNone, float] = (
        None  # Three-phase line voltage Ubc, e.g. 0
    )
    voltage_uc: Union[EmptyStrToNone, float] = (
        None  # Three-phase phase voltage Uc, e.g. 0
    )
    voltage_uca: Union[EmptyStrToNone, float] = (
        None  # Three-phase line voltage Uca, e.g. 0
    )
    with_time: Union[EmptyStrToNone, bool] = None  # e.g. False
    zero_line_max_need: Union[EmptyStrToNone, float] = (
        None  # zero line current maximum demand, e.g. 0
    )
    zero_line_need: Union[EmptyStrToNone, float] = (
        None  # The current zero line current demand, e.g. 0
    )
