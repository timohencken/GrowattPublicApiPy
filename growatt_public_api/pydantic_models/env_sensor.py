...
class EnvSensorData(ApiModel):
    ...
    device_type: Union[EmptyStrToNone, str] = (
        None  # Device type (48: environmental tester), e.g. '48'
    )
...
class EnvSensorMetricsOverviewData(ApiModel):
    ...
    env_temp: Union[EmptyStrToNone, float] = (
        None  # Ambient temperature, e.g. 32.400001525878906
    )
    ...
    panel_temp: Union[EmptyStrToNone, float] = (
        None  # Panel temperature, e.g. 31.899999618530273
    )
    ...
    time_text: Union[EmptyStrToNone, datetime.datetime] = (
        None  # Last update time, e.g. '2019-01-09 13:37:33'
    )
    total_rainfall: Union[EmptyStrToNone, float] = None  # e.g. 0
    wind_angle: Union[EmptyStrToNone, float] = None  # Wind direction, e.g. 1
    wind_speed: Union[EmptyStrToNone, float] = (
        None  # wind speed, e.g. 0.10000000149011612
    )
