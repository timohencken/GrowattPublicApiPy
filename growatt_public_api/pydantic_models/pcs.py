...
class PcsSettingRead(ApiResponse):
...
class PcsSettingWrite(ApiResponse):
...
class PcsEnergyOverviewData(ApiModel):
    ...
    ppv_inverter: Union[EmptyStrToNone, float] = (
        None  # Photovoltaic inverter power generation, e.g. 6.8
    )
